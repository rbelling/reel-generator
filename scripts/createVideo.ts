import { render, instagramReelConfig } from "../src/lib/video"
import path from "path"
import { saveToTempFolder } from "../src/lib/storage"

// createVideo(
//   {
//     config: instagramReelConfig,
//     outputPath: path.join(__dirname, "../../media", "video.mp4"),
//   },
//   [
...
async function saveToFile(imageUrls: string[]) {
  saveToTempFolder(imageUrls)
    .then(() => process.exit(0))
    .catch(() => process.exit(1))
}

saveToFile(["https://cdn.spoak.com/palette-sample.jpeg"])
